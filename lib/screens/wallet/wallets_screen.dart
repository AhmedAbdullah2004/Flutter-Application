                    ...
                    return Card(
                      ...
                      child: ListTile(
                        leading: CircleAvatar(
                          ...
                          child: Text(wallet.currencyCode, style: const TextStyle(fontWeight: FontWeight.bold)),
                        ),
                        title: Text('${wallet.balance.toStringAsFixed(2)} ${wallet.currencyCode}'),
                        subtitle: Text('تم الإنشاء: ${wallet.createdAt.substring(0, 10)}'),
